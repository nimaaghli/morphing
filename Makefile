...
# Template: app
# Command: /home/nima/Qt5.3.1/5.3/gcc/bin/qmake -spec linux-g++ CONFIG+=debug -o Makefile Morphing.pro
#############################################################################
...
INCPATH       = -I../Qt5.3.1/5.3/gcc/mkspecs/linux-g++ -I. -I/usr/local/include/opencv2 -I../Qt5.3.1/5.3/gcc/include -I../Qt5.3.1/5.3/gcc/include/QtWidgets -I../Qt5.3.1/5.3/gcc/include/QtGui -I../Qt5.3.1/5.3/gcc/include/QtCore -I. -I.
LINK          = g++
LFLAGS        = -Wl,-rpath,/home/nima/Qt5.3.1/5.3/gcc -Wl,-rpath,/home/nima/Qt5.3.1/5.3/gcc/lib
LIBS          = $(SUBLIBS) -L/usr/local/lib -lopencv_core -lopencv_imgproc -lopencv_highgui -lopencv_ml -lopencv_video -lopencv_features2d -lopencv_calib3d -lopencv_objdetect -lopencv_contrib -lopencv_legacy -lopencv_flann -lopencv_nonfree -L/home/nima/Qt5.3.1/5.3/gcc/lib -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /home/nima/Qt5.3.1/5.3/gcc/bin/qmake
TAR           = tar -cf
COMPRESS      = gzip -9f
COPY          = cp -f
SED           = sed
...
DIST          = ../Qt5.3.1/5.3/gcc/mkspecs/features/spec_pre.prf \
		...
		Morphing.pro main.cpp \
		morphing.cpp
QMAKE_TARGET  = Morphing
...
$(TARGET): ui_morphing.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Morphing.pro ../Qt5.3.1/5.3/gcc/mkspecs/linux-g++/qmake.conf ../Qt5.3.1/5.3/gcc/mkspecs/features/spec_pre.prf \
		../Qt5.3.1/5.3/gcc/mkspecs/common/shell-unix.conf \
		../Qt5.3.1/5.3/gcc/mkspecs/common/unix.conf \
		../Qt5.3.1/5.3/gcc/mkspecs/common/linux.conf \
		../Qt5.3.1/5.3/gcc/mkspecs/common/gcc-base.conf \
		...
		../Qt5.3.1/5.3/gcc/mkspecs/features/lex.prf \
		Morphing.pro \
		/home/nima/Qt5.3.1/5.3/gcc/lib/libQt5Widgets.prl \
		/home/nima/Qt5.3.1/5.3/gcc/lib/libQt5Gui.prl \
		/home/nima/Qt5.3.1/5.3/gcc/lib/libQt5Core.prl
	$(QMAKE) -spec linux-g++ CONFIG+=debug -o Makefile Morphing.pro
...
dist: 
	@test -d .tmp/Morphing1.0.0 || mkdir -p .tmp/Morphing1.0.0
	$(COPY_FILE) --parents $(DIST) .tmp/Morphing1.0.0/ && $(COPY_FILE) --parents morphing.h .tmp/Morphing1.0.0/ && $(COPY_FILE) --parents main.cpp morphing.cpp .tmp/Morphing1.0.0/ && $(COPY_FILE) --parents morphing.ui .tmp/Morphing1.0.0/ && (cd `dirname .tmp/Morphing1.0.0` && $(TAR) Morphing1.0.0.tar Morphing1.0.0 && $(COMPRESS) Morphing1.0.0.tar) && $(MOVE) `dirname .tmp/Morphing1.0.0`/Morphing1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Morphing1.0.0
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_morphing.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_morphing.cpp
moc_morphing.cpp: ../Qt5.3.1/5.3/gcc/include/QtWidgets/QMainWindow \
		...
		morphing.h
	/home/nima/Qt5.3.1/5.3/gcc/bin/moc $(DEFINES) -I/home/nima/Qt5.3.1/5.3/gcc/mkspecs/linux-g++ -I/home/nima/morphing -I/usr/local/include/opencv2 -I/home/nima/Qt5.3.1/5.3/gcc/include -I/home/nima/Qt5.3.1/5.3/gcc/include/QtWidgets -I/home/nima/Qt5.3.1/5.3/gcc/include/QtGui -I/home/nima/Qt5.3.1/5.3/gcc/include/QtCore morphing.h -o moc_morphing.cpp

compiler_moc_source_make_all:
compiler_moc_source_clean:
compiler_uic_make_all: ui_morphing.h
compiler_uic_clean:
	-$(DEL_FILE) ui_morphing.h
ui_morphing.h: morphing.ui
	/home/nima/Qt5.3.1/5.3/gcc/bin/uic morphing.ui -o ui_morphing.h
...
morphing.o: morphing.cpp ../Qt5.3.1/5.3/gcc/include/QtCore/qmath.h \
		../Qt5.3.1/5.3/gcc/include/QtCore/qglobal.h \
		../Qt5.3.1/5.3/gcc/include/QtCore/qconfig.h \
		../Qt5.3.1/5.3/gcc/include/QtCore/qfeatures.h \
		../Qt5.3.1/5.3/gcc/include/QtCore/qsystemdetection.h \
		...
		../Qt5.3.1/5.3/gcc/include/QtCore/qmutex.h \
		../Qt5.3.1/5.3/gcc/include/QtCore/qnumeric.h \
		../Qt5.3.1/5.3/gcc/include/QtWidgets/QFileDialog \
		...
		../Qt5.3.1/5.3/gcc/include/QtGui/QVector2D
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o morphing.o morphing.cpp

moc_morphing.o: moc_morphing.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_morphing.o moc_morphing.cpp
